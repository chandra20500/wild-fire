var num = 0;
	...
	function show_member(a){
        ...
        var p = ["445323851","1239782111","1866153452","1198791653","1570931320","621170297","411955678","39302270","1683838306"];
        var n = ["803889543","394205440","1775770105","1575972272","881550564","1100532922","1832313068","171007711","272318623"];
		...
		for (counter = 1; counter < a; counter++) {
			...
			newTextBoxDiv.after().html('<p><input type="text"  id="name'+count+'" name="entry.'+n[count-2]+'" class="input-field" placeholder="Member '+count+' Name"  required></p><p><input type="number" id="mobile'+count+'" name="entry.'+p[count-2]+'" class="input-field"  placeholder="Mobile No." required></p> <br></br>');   
